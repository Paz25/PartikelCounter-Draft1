...
<div class="section p-2">
  <!-- <form action="<?= site_url('particle/limits') ?>" method="post"> -->
    <?= csrf_field() ?>

    <div class="row g-2 align-items-center">
      <!-- Kiri: label + dropdown (inline) -->
      ...
      <!-- Baris bawah: teks sampling full width -->
      <div class="col-12">
        <div class="small text-muted border-top pt-2">
          calculating (<?= esc($elapsed_sec) ?> s), sampling <?= esc($sampling_now) ?> of <?= esc($sampling_total) ?>
        </div>
      </div>
    </div>
  <!-- </form> -->
