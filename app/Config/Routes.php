...
$routes->group('api', ['namespace' => 'App\Controllers\Api'], function ($routes) {
    ...
    $routes->post('partikel/start', 'PartikelController::start');
    $routes->post('partikel/stop', 'PartikelController::stop');
    $routes->get('partikel/status', 'PartikelController::status');
});
